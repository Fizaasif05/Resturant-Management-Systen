...
int main(){
	int opt;
		cout<<"1. Restaurant Management \n2. Employee Information"<<endl;
		cin>>opt;
		switch(opt){
	case 1:
	cout<<endl<<"\t\t=========Resturant Mangement System========="<<endl<<endl;
	...
	int t,e,f;
	for(int j=0; j<3; j++){
	cout<<"enter the name of "<<j+1<<" employees:";
	cin>>n[j];
	cout<<"enter the "<<j+1<<" employee id: ";
	cin>>h[j];
	...
	int w=5;
	int d;
	cout<<"Enter the working days of manager :";
	cin>>d;
	if(d<5 || d==5){
		t=som-(1000*(5-d));
	cout<<"The salary of manager is "<<t<<endl;}
	int sos=40000;
	int x=5;
	cout<<"Enter the working days of supervisor :";
	cin>>x;
	if(d<5 || d==5 ){
		e=sos-(1000*(5-x));
	cout<<"The salary of manager is "<<e<<endl;
	int sow=30000;
	int w=5;
	int d;
	cout<<"Enter the working days of worker :";
	cin>>d;
	if(d<5 || d==5){
		f=sow-(1000*(5-d));
	cout<<"The salary of manager is "<<f<<endl;
	
		cout<<"Employee Name"<<"\t"<<"Employee id"<<"\t"<<"Description"<<"\t\t"<<"Salary"<<endl;
		cout<<"\t"<<n[0]<<"\t\t"<<h[0]<<"\t\t"<<o[0]<<"\t\t"<<t<<endl;
		cout<<"\t"<<n[1]<<"\t\t"<<h[1]<<"\t\t"<<o[1]<<"\t"<<e<<endl;
		cout<<"\t"<<n[2]<<"\t\t"<<h[2]<<"\t\t"<<o[2]<<"\t\t"<<f<<endl;
		return 0;
}}}}
